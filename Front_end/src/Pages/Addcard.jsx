...
const Cart = () => {
  ...
  // Initial cart data (in a real application, this would be fetched from the backend or state)
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <div className="bg-white rounded-xl shadow-md p-6 mt-6">
                ...
                {couponMessage && (
                  <div className={`mb-3 p-2 text-sm rounded ${discountApplied ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}>
                    {couponMessage}
                  </div>
                )}
