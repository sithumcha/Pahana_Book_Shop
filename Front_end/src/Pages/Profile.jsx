...
import { FiUser, FiMail, FiPhone, FiMapPin, FiCalendar, FiEdit, FiLogOut, FiSave, FiShoppingCart, FiEye, FiEyeOff } from 'react-icons/fi';
                  ...
                  <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <div className="md:w-2/3 space-y-4">
                          ...
                          {formData.password && (
                            <div className="mt-2">
                              {passwordErrors.length === 0 ? (
                                <p className="text-green-600 text-sm">Password meets all requirements</p>
                              ) : (
                                <div className="bg-red-50 p-3 rounded-lg">
                                  <p className="text-red-800 font-medium text-sm mb-1">Password must meet the following requirements:</p>
                      ...
                      <div className="pt-4">
                        <button
                          type="submit"
                          disabled={formData.password && passwordErrors.length > 0}
                          className={`flex items-center justify-center w-full md:w-auto px-6 py-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-lg hover:shadow-lg hover:shadow-purple-500/20 transition-all ${
                            formData.password && passwordErrors.length > 0 ? 'opacity-50 cursor-not-allowed' : ''
                          }`}
                        >
