...
const BookDetails = () => {
  ...
  const handleAddToWhitelist = () => {
    ...
    navigate('/whitelist'); // Navigate to the whitelist page after adding the book
  };
            ...
            <div className="lg:w-2/5 p-8 bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center">
              <motion.div whileHover={{ scale: 1.02 }} className="relative">
                ...
                <div 
                  ...
                  className="absolute -bottom-4 -right-4 bg-white p-3 rounded-full shadow-md cursor-pointer"
                >
                  <FaHeart className="text-red-500 text-2xl" />
                </div>
              </motion.div>
