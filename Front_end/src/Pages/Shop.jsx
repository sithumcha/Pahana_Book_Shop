...
const BookShop = () => {
  ...
  const handleAddToCart = (book) => {
    ...
    const existingIndex = existingCart.findIndex(item => item.bookTitle === book.title);
            ...
            {filteredBooks.map((book) => (
              ...
              >
                ...
                <div className="relative h-64 bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center">
                  ...
                  />
                  <div className="absolute top-2 right-2 bg-white rounded-full p-2 shadow-md cursor-pointer" onClick={() => handleAddToCart(book)}>
                    <FaShoppingCart className="text-indigo-600" />
                  </div>
                </div>
