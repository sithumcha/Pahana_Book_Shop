          ...
          <div>
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                {['Facebook', 'Twitter', 'Instagram', 'Goodreads'].map((platform) => (
                  <a 
                    key={platform} 
                    href="#" 
                    className="bg-white p-3 rounded-lg shadow-sm hover:shadow-md transition flex items-center space-x-2"
                  >
                    <span className="text-indigo-600">{platform.slice(0, 1)}</span>
